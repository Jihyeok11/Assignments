...
#     concept_name = models.CharField(max_lenght=1000, null=True)
#     domain_id = models.CharField(max_length=100, null=True)
#     vocabulary_id = models.CharField(max_length=100, null=True)
#     concept_class_id = models.CharField(max_length=100, null=True)
#     standard_concept = models.CharField(max_lenght=100, null=True)
#     concept_code = models.CharField(max_length=100, null=True)
#     valid_start_date = models.DateField(null=True)
#     valid_end_date = models.DateField(null=True)
#     invalid_reason = models.CharField(max_lenght=100, null=True)